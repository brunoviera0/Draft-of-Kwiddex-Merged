                    ...
                    <Card>
                      ...
                      <CardContent>
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                          ...
                          {certResult.reviewer_id && <div className="flex items-start gap-2"><User className="w-4 h-4 mt-0.5 text-muted-foreground shrink-0" /><div><p className="text-xs text-muted-foreground">Certified Using</p><p className="text-sm font-medium">{certResult.reviewer_id}</p></div></div>}
                        </div>
